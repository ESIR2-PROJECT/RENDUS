...
Fin: 6 janvier  
Objectifs : 
- Afficher une carte avec des points sur un site wweb
...
Il a également fallu gérer les problèmes de dates dans la dataset. Effectivement, un bon nombre de bornes possèdent la date 01-01-1971 ou 01-01-2000. Ce sont des dates par default qui ne correspondent pas à la réalité. Nous les affichons donc comme rouges sur la carte.
...
![Diagramme de flux cumulé du projet](doc/issue_count.png)
